...
(Note that a quasi-quoted string cannot contain the substring "`|}`", hence the use of two literals in the `_eos` rule.) A parser term is built from the grammar source using `peg_compile/2`.
...
[pPEGref]: https://ridgeworks.github.io/pPEGpl/pPEG_API_Guide.md
[oldpPEGref]: https://github.com/ridgeworks/pPEGpl/blob/main/doc/pPEG_API_Guide.md
